<?php
$EMAIL = 'sales@euro-snab.store'; //  Ваш e-mail на который будут приходить заявки
$FROM = 'zakaz@euro-snab.store';  //  e-mail отправителя (иногда требуется указать разрешенный настройками e-mail)
$REPLY = 'sales@euro-snab.store';   //  e-mail для ответа
